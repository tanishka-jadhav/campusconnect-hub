...
export default function AppLayout({ activeModule, onNavigate, children }) {
  ...
  return (
    <div className="min-h-screen flex bg-background text-foreground relative transition-colors duration-200">
      ...
      <aside className="hidden lg:flex flex-col w-72 border-r border-border bg-card/30 backdrop-blur-xl shadow-2xl h-screen sticky top-0 z-30 shrink-0 transition-colors duration-200">
        ...
        <div className="p-4 border-t border-border space-y-4">
          ...
          <Button
            variant="ghost"
            size="default"
            className="w-full h-11 justify-start text-muted-foreground hover:text-red-500 hover:bg-red-500/10 rounded-xl px-4 border border-transparent hover:border-red-500/20 cursor-pointer"
      ...
      {/* Main Panel Content */}
      <main className="flex-1 flex flex-col min-w-0 relative bg-background text-foreground transition-colors duration-200">
